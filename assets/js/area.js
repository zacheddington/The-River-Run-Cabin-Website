...
(function () {
  ...
  attractions.forEach((attraction, index) => {
    ...
    heading.textContent = attraction.title;
    ...
    if (attraction.description.length > MAX_DESC_LENGTH) {
      para.append(" ");
      const seeMore = document.createElement("button");
      seeMore.className = "see-more";
      seeMore.type = "button";
      seeMore.dataset.idx = index;
      seeMore.textContent = "(see more)";
      para.appendChild(seeMore);
    }
    card.appendChild(para);

    const link = document.createElement("a");
    link.setAttribute("href", attraction.link);
